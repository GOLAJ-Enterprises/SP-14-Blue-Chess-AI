...
class LegalMoveGenerator:
    ...
    def get_moves(self, bitpos: int) -> set[Move]:
        ...
        king_sq = lsb(king_bb)
        enemy_attacks = self.board.attacked[opp_color(color)]
        ...
        for move in pseudo_moves:
            ...
            if bitpos == king_sq:
                ...
                if not mask(move.to_sq) & enemy_attacks:
                ...
                if mask(bitpos) & pinned:
                    if not is_along_ray(bitpos, move.to_sq, king_sq):
                        continue
    ...
    def get_all_moves(self) -> set[Move]:
        ...
        for bitpos in self.board.piece_map.keys():
